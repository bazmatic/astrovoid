...
class ReplayEnemyShip(RotatingThrusterShip):
    ...
    # Command dispatch mapping - maps CommandType to handler methods
    _COMMAND_HANDLERS = {
        CommandType.ROTATE_LEFT: lambda self: self.rotate_left(),
        CommandType.ROTATE_RIGHT: lambda self: self.rotate_right(),
        CommandType.APPLY_THRUST: lambda self: self.apply_thrust(),
        CommandType.NO_ACTION: lambda self: None,  # Do nothing - mirrors player inactivity
    ...
    def update(self, dt: float) -> None:
        ...
        if replay_commands:
            ...
            self._execute_command(cmd_type)
    ...
    def _execute_command(self, command_type: CommandType) -> None:
